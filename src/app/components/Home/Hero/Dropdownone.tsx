...
const isCourseResponse = (value: unknown): value is CourseResponse => {
  return (
    typeof value === 'object' &&
    value !== null &&
    'CourseData' in value &&
    Array.isArray((value as { CourseData: unknown }).CourseData)
  );
};
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (isCourseResponse(data)) {
          setCourse(data.CourseData);
          setSelected(data.CourseData[0] ?? null);
        } else {
