    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-gray-200 p-3.5 text-black hover:cursor-pointer hover:bg-neutral-100"
        >
          Sign Up
          <svg
            width="23"
