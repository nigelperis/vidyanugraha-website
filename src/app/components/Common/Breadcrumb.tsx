...
const Breadcrumb: React.FC<BreadcrumbProps> = ({
  ...
  return (
    <div className="dark:bg-darkmode relative z-10 overflow-hidden pt-[120px] pb-[60px] md:pt-[130px] lg:pt-[160px]">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            <div className="text-center">
              ...
              <p className="dark:text-black-6 mb-5 text-base text-black">
                {pageDescription}
              </p>
              ...
              <ul className="flex items-center justify-center gap-[10px]">
                <li>
                  <Link
                    href="/"
                    className="dark:text-opacity-50 flex items-center gap-[10px] text-base font-medium text-black dark:text-white"
                  >
                    Home
                  </Link>
                </li>
                <li>
                  <p className="text-body-color flex items-center gap-[10px] text-base font-medium">
                    <span className="text-body-color dark:text-opacity-50 dark:text-white">
                      {' '}
                      /{' '}
                    </span>
                    {pageName}
